...
const ICONS: Record<string, LucideIcon> = {
  ...
  "json-to-excel": FileJson,
  "excel-to-json": FileSpreadsheet,
  "tsv-to-csv": Table,
  "csv-to-tsv": Table,
  "tsv-to-excel": FileSpreadsheet,
  "excel-to-tsv": FileSpreadsheet,
  "yaml-to-json": FileCode,
  "json-to-yaml": FileJson,
  "markdown-to-html": FileCode,
  "html-to-markdown": Code2,
  "html-to-text": AlignLeft,
  "text-to-html": CodeXml,
  "base64-encode": Lock,
  "base64-decode": Unlock,
  "url-encode": Link,
  "url-decode": Link2,
  "json-formatter": Braces,
  "json-minifier": Minimize2,
  "json-validator": CheckCircle2,
  "xml-formatter": CodeXml,
  "xml-minifier": Minimize2,
  "xml-validator": CheckCircle2,
  "csv-formatter": Table,
  "csv-cleaner": Eraser,
  "duplicate-row-remover": CopyX,
  "column-extractor": Columns3,
  "csv-splitter": Scissors,
  "csv-merger": Merge,
  "excel-sheet-extractor": FileOutput,
  "excel-sheet-merger": FileStack,
  "sql-to-csv": Binary,
  "csv-to-sql": Binary,
  "sql-to-json": Binary,
  "json-to-sql": Binary,
