...
export const TOPIC_CLUSTERS: readonly TopicCluster[] = [
  ...
  {
    id: "topic-pdf-organization",
    name: "PDF Organization (Merge, Split & Page Management)",
    pillar: { type: "tool", id: "tool-merge-pdf" },
    supporting: [
      { type: "tool", id: "tool-split-pdf" },
      { type: "tool", id: "tool-rotate-pdf" },
      { type: "tool", id: "tool-delete-pages" },
      { type: "tool", id: "tool-extract-pages" },
      { type: "tool", id: "tool-rearrange-pages" },
      { type: "tool", id: "tool-duplicate-pages" },
      ...
      { type: "comparison", id: "comparison-merge-pdf-vs-combine-pdf" },
      { type: "comparison", id: "comparison-split-pdf-vs-merge-pdf" },
      { type: "use-case", id: "use-case-combine-bank-statements-into-one-pdf" },
      { type: "use-case", id: "use-case-merge-invoices-into-one-pdf" },
  ...
  },
  {
    ...
    name: "Data Conversion (CSV/Excel/XML/JSON/SQL)",
    ...
    supporting: [
      ...
      { type: "tool", id: "tool-excel-to-json" },
      { type: "tool", id: "tool-tsv-to-csv" },
      { type: "tool", id: "tool-csv-to-tsv" },
      { type: "tool", id: "tool-tsv-to-excel" },
      { type: "tool", id: "tool-excel-to-tsv" },
      ...
      { type: "tool", id: "tool-json-to-sql" },
      { type: "tool", id: "tool-json-to-xml" },
      { type: "tool", id: "tool-xml-to-json" },
      { type: "tool", id: "tool-yaml-to-xml" },
      { type: "tool", id: "tool-xml-to-yaml" },
      { type: "guide", id: "guide-how-csv-excel-xml-conversion-works" },
      { type: "guide", id: "guide-how-pdfpilots-data-format-tools-fit-together" },
      { type: "guide", id: "guide-understanding-yaml-and-json" },
      { type: "comparison", id: "comparison-csv-to-xml-vs-excel-to-xml" },
      { type: "comparison", id: "comparison-json-vs-csv" },
      { type: "use-case", id: "use-case-prepare-a-spreadsheet-export-for-a-data-import" },
      { type: "use-case", id: "use-case-migrate-a-legacy-sql-export-to-a-spreadsheet" },
      { type: "use-case", id: "use-case-prepare-api-json-data-for-a-non-technical-teammate" },
      { type: "learning-resource", id: "learning-resource-what-is-xml" },
      { type: "learning-resource", id: "learning-resource-what-is-json" },
      { type: "learning-resource", id: "learning-resource-what-is-yaml" },
      { type: "industry", id: "industry-accounting-finance" },
    ],
  },
  {
    id: "topic-markup-and-encoding",
    name: "Markup & Encoding Tools",
    pillar: { type: "tool", id: "tool-markdown-to-html" },
    supporting: [
      { type: "tool", id: "tool-html-to-markdown" },
      { type: "tool", id: "tool-html-to-text" },
      { type: "tool", id: "tool-text-to-html" },
      { type: "tool", id: "tool-base64-encode" },
      { type: "tool", id: "tool-base64-decode" },
      { type: "tool", id: "tool-url-encode" },
      { type: "tool", id: "tool-url-decode" },
      { type: "learning-resource", id: "learning-resource-what-is-base64-encoding" },
      { type: "comparison", id: "comparison-base64-encode-vs-base64-decode" },
      { type: "comparison", id: "comparison-markdown-to-html-vs-html-to-markdown" },
    ],
  },
  {
    id: "topic-data-formatting-and-cleanup",
    name: "Data Formatting & Cleanup Tools",
    pillar: { type: "tool", id: "tool-json-formatter" },
    supporting: [
      ...
      { type: "tool", id: "tool-column-extractor" },
      { type: "tool", id: "tool-csv-splitter" },
      { type: "tool", id: "tool-csv-merger" },
      { type: "tool", id: "tool-excel-sheet-extractor" },
      { type: "tool", id: "tool-excel-sheet-merger" },
      { type: "comparison", id: "comparison-csv-cleaner-vs-duplicate-row-remover" },
      { type: "comparison", id: "comparison-json-formatter-vs-json-minifier" },
      { type: "guide", id: "guide-how-json-xml-and-csv-formatting-validation-and-minifying-work" },
    ],
  },
  {
    id: "topic-text-to-pdf",
    name: "Plain Text, Markdown & CSV to PDF",
    pillar: { type: "tool", id: "tool-txt-to-pdf" },
    supporting: [
      { type: "tool", id: "tool-markdown-to-pdf" },
      { type: "tool", id: "tool-csv-to-pdf" },
      { type: "guide", id: "guide-how-text-based-files-convert-to-pdf" },
    ],
  },
  {
    id: "topic-scanning",
