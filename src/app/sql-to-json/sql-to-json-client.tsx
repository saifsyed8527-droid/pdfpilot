...
interface SqlToJsonClientProps {
  faqs: FaqInput[];
  related: ResolvedEntity[];
}

export function SqlToJsonClient({ faqs, related }: SqlToJsonClientProps) {
            ...
            {file && !result && (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  using a real SQL parser. Every statement in the file must target the same
                  column list.
                </p>
