...
interface ExcelToCsvClientProps {
  faqs: FaqInput[];
  related: ResolvedEntity[];
}

export function ExcelToCsvClient({ faqs, related }: ExcelToCsvClientProps) {
          ...
          <CardContent className="space-y-6">
            ...
            {file && !result && (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  Reads your workbook&apos;s first sheet and writes it out as CSV. If your file has
                  multiple sheets, use Excel Sheet Extractor first to pick the one you want.
                </p>
