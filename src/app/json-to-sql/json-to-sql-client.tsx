...
interface JsonToSqlClientProps {
  faqs: FaqInput[];
  related: ResolvedEntity[];
}

export function JsonToSqlClient({ faqs, related }: JsonToSqlClientProps) {
          ...
          <CardContent className="space-y-6">
            ...
            {file && !result && (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  Expects a JSON array of objects. Values that look like numbers are written
                  unquoted; everything else is written as an escaped, quoted string.
                </p>
