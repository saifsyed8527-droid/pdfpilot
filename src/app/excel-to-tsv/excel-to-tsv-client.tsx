...
interface ExcelToTsvClientProps {
  faqs: FaqInput[];
  related: ResolvedEntity[];
}

export function ExcelToTsvClient({ faqs, related }: ExcelToTsvClientProps) {
  ...
  const convert = () => {
    ...
    run(
      async () => {
        ...
        setResult(new Blob([tsv], { type: "text/tab-separated-values" }));
      },
      {
        successMessage: "Converted to TSV successfully!",
        toolName: "excel-to-tsv",
        errorTitle: "Failed to convert to TSV",
        onError: (error) =>
  ...
  const downloadResult = () => {
    if (!result) return;
    downloadBlob(result, "converted.tsv");
  };
          ...
          <CardContent className="space-y-6">
            ...
            {file && !result && (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  Converts the workbook&apos;s first sheet. Other sheets in a multi-sheet workbook
                  aren&apos;t included.
                </p>
            ...
            {result && (
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold">Converted to TSV successfully!</h3>
