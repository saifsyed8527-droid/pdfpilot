...
import { jsonToRows, rowsToXml } from "@/lib/engines/data-conversion-engine";
import type { ResolvedEntity } from "@/lib/content/registry";
import { ToolRelatedContent } from "@/components/content/ToolRelatedContent";

interface JsonToXmlClientProps {
  faqs: FaqInput[];
  related: ResolvedEntity[];
}

export function JsonToXmlClient({ faqs, related }: JsonToXmlClientProps) {
          ...
          <CardContent className="space-y-6">
            ...
            {file && !result && (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  Expects a JSON array of objects. Each object becomes a <code>&lt;row&gt;</code>{" "}
                  element with one child element per key.
                </p>
