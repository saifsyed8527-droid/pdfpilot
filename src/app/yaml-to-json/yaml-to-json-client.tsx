...
import { yamlToJson } from "@/lib/engines/data-conversion-engine";
...
export function YamlToJsonClient({ faqs, related }: YamlToJsonClientProps) {
  ...
  const convert = () => {
    ...
    run(
      ...
      },
      {
        ...
        onError: (error) =>
          error instanceof Error ? error.message : "Please try again with a valid YAML file",
      }
    );
  };
