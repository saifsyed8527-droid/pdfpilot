...
export function ExcelToPdfClient({ faqs, related }: ExcelToPdfClientProps) {
    ...
    run(
      ...
      },
      {
        ...
        onError: (error) => {
          ...
          return error instanceof Error ? error.message : "Please try again with a valid Excel file";
        },
      }
    );
  };
          ...
          <CardContent className="space-y-6">
            ...
            {file && !resultPdf && (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  This converts your spreadsheet&apos;s text and tables into a clean PDF — cell
                  formatting, colors, charts, and the exact grid layout aren&apos;t preserved.
                </p>
